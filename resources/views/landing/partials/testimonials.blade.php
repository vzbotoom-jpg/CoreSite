...
<section class="py-20 bg-light-surface dark:bg-dark-surface">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Ringkasan rating dari platform pihak ketiga — social proof yang
             lebih kredibel dibanding testimoni yang cuma ditampilkan sendiri
             oleh CoreSite tanpa verifikasi eksternal.
             CATATAN: ganti link & angka di bawah sesuai listing asli CoreSite
             di Google Business Profile / Trustpilot / Play Store, dsb. --}}
        <div class="flex flex-wrap items-center justify-center gap-8 mt-12 pt-8 border-t border-light-border dark:border-dark-border">
            <div class="flex items-center gap-2 text-text-secondary">
                <svg class="w-5 h-5 text-warning" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
                <span><strong class="text-text-primary">4.9/5</strong> Rating Pengguna</span>
            </div>
            <a href="#" target="_blank" class="text-accent text-sm font-medium hover:underline">
                Lihat semua ulasan →
            </a>
        </div>
    </div>
